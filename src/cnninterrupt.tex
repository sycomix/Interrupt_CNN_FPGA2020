...
As introduces in \Cref{sec:vitualinter}, the only the input data are shared across the CalcBlobs. At the recovery step of CALC\_F, there is no need to recovery the weights. Thus, the recovery virtual instruction only restores the shared input data.
